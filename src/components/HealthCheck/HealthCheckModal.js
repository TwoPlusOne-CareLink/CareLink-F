...
import { __getHealthCheckDetail } from "../../redux/modules/healthCheckSlice"

function HealthCheckModal({ checkListInfoDtoList }) {
                      ...
                      <PostModalContentBody key={item.checkId}>
                        ...
                        <PostStandardResults>
                          ...
                          <PostStandardResult>
                            ...
                            <PostStandardText>{item.hrResult}</PostStandardText>
                          </PostStandardResult>
                          <PostStandardResult>
                            <PostStandardTitle>혈당</PostStandardTitle>
                            <PostStandardText>{item.bsResult}</PostStandardText>
                          </PostStandardResult>
                          <PostStandardResult>
                            <PostStandardTitle>혈압</PostStandardTitle>
                            <PostStandardText>{item.bpResult}</PostStandardText>
                          </PostStandardResult>
                        </PostStandardResults>
                        <PostModalContentTexts>
                          <PostModalContentTextTitle>
                            <ContentTitle>세부내용</ContentTitle>
                          </PostModalContentTextTitle>
